...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Go To Electricals — Bulawayo's Trusted Electrical Contractors" },
      ...
      { property: "og:title", content: "Go To Electricals — Bulawayo's Trusted Electrical Contractors" },
      ...
      { name: "twitter:title", content: "Go To Electricals — Bulawayo's Trusted Electrical Contractors" },
